...
SECRET_KEY = 'django-insecure-+bn72qq0=k5!b)fzkno)i6!pv=0gwba+9ld7dg*1s4xai@!bdx'
...
CLOUDFLARE_R2_BUCKET_NAME = os.environ.get('CLOUDFLARE_R2_BUCKET_NAME', "printer")
CLOUDFLARE_R2_REGION = os.environ.get('CLOUDFLARE_R2_REGION', 'auto') # Default to 'auto'
